...
public enum LoggerStringKey implements Name{
	...
	ToolPlatform_FlowProvider_34(new DefaultName("ToolPlatform.FlowProvider.34")),
	ToolPlatform_FlowProvider_35(new DefaultName("ToolPlatform.FlowProvider.35")),
	ToolPlatform_FlowProvider_36(new DefaultName("ToolPlatform.FlowProvider.36")),
	ToolPlatform_FlowProvider_37(new DefaultName("ToolPlatform.FlowProvider.37")),
	ToolPlatform_FlowProvider_38(new DefaultName("ToolPlatform.FlowProvider.38")),
	ToolPlatform_FlowProvider_39(new DefaultName("ToolPlatform.FlowProvider.39")),
	ToolPlatform_FlowProvider_40(new DefaultName("ToolPlatform.FlowProvider.40")),
	ToolPlatform_FlowProvider_41(new DefaultName("ToolPlatform.FlowProvider.41")),
	ToolPlatform_FlowProvider_42(new DefaultName("ToolPlatform.FlowProvider.42")),
	ToolPlatform_FlowProvider_43(new DefaultName("ToolPlatform.FlowProvider.43")),
	...
	ToolPlatform_Exitor_13(new DefaultName("ToolPlatform.Exitor.13")),
	ToolPlatform_Exitor_14(new DefaultName("ToolPlatform.Exitor.14")),
	ToolPlatform_Exitor_15(new DefaultName("ToolPlatform.Exitor.15")),
	ToolPlatform_Exitor_16(new DefaultName("ToolPlatform.Exitor.16")),
