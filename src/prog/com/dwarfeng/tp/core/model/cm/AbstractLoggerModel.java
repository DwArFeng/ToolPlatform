...
public abstract class AbstractLoggerModel implements LoggerModel {
	 ...
	 */
	@Override
	public final Set<LoggerObverser> getObversers() {
		lock.readLock().lock();
		try{
	 ...
	 */
	@Override
	public final boolean addObverser(LoggerObverser obverser) {
		lock.writeLock().lock();
		try{
	 ...
	 */
	@Override
	public final boolean removeObverser(LoggerObverser obverser) {
		lock.writeLock().lock();
		try{
